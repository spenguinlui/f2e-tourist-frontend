    ...
    <div class="login-card-container">
      ...
      <div class="login-card" ref="loginCard">
        <header class="login-card-header">
          <div type="button" class="login-card-header-btn">修改密碼</div>
        </header>
        <section class="login-card-section">
          <form action="post" class="form">
            <label class="form-input">
              <input type="password" v-model="new_password"  placeholder=" " class="form-input-field" required="required">
            ...
            <div class="btn-group">
              <button type="submit" @click.prevent.stop="resetPassword" class="form-btn">修改密碼</button>
            </div>
          </form>
        </section>
      </div>
